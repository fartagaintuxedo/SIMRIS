...
# HA 175 (standard construction concrete)
...
def load_material(material_id, hinge_dist_percentage):
    ...
    fck = -17500.0 # (KN/m2) HA 175
    fc = -24500.0 # (KN/m2) HA 175 --> fck + 8MPa (8000KN/m2) according to EUROCODE (we add only 7 to be safer)
    ...
    concrete04_HA175 = mat.Material(material_id, 
                                   "concrete04_HA175",
