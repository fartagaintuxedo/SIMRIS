...
def load_material(material_id):
    ...
    fy = 222000.0 # --> 400000 * 0.555 (according to https://doi.org/10.1680/jmacr.18.00052)
    fu = 244200.0  # ultimate strength --> 440000 * 0.555 (bis) & (--> UNE 36068:2011) 
    E0 = 126000000.0 # (according to https://doi.org/10.1680/jmacr.18.00052)
    eu = 0.05 # --0.24 # strain at ultimate strength (5% --> UNE 36068:2011)
    ...
    steel02_A400S_non_corrugated = mat.Material(material_id,
                                                "steel02_A400S_non_corrugated",
    ...
    return steel02_A400S_non_corrugated