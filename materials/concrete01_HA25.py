...
def load_material(material_id):
    ...
    fpc = -32000.0 # (KN/m2) HA 25 --> fck + 8MPa (8000KN/m2) according to EUROCODE (we add only 7 to be safer)
    epsc0 = -0.0021 # (% --> UNE-EN 1992-1-1:2013)
    ...
    concrete01_HA25 = mat.Material(material_id, 
                                   "concrete01_HA25",
